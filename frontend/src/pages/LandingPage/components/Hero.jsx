        ...
        <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <motion.p
                    ...
                    className="text-xl md:text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-tight"
                >
                ...
                >
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
                    ...
                    <motion.button
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="bg-white border-2 border-gray-200 text-gray-700 px-8 rounded-xl font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
                        onClick={() => {
                            navigate(
                ...
                <motion.div
                    ...
                    className="grid gird-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto"
                >
                    {stat.map((stat, index) => (
                        <motion.div
                            key={index}
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 30 }}
                            transition={{ delay: 0.8 + index * 1, duration: 0.6 }}
                            className="flex flex-col items-center space-y-2 p-4 rounded-xl font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
                        >
