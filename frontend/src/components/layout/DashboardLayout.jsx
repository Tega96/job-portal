...
const DashboardLayout = ({ activeMenu, children }) => {
  ...
  return (
    ...
    <div className="flex h-screen bg-gray-50">
        {/* Sidebar */}
        <div
            className={`fixed inset-y-0 left-0 z-0 transition-transform duration-300 transform ${
                isMobile
                    ? sidebarOpen
                        ? "translate-x-0"
                        : "-translate-x-full"
        ...
        {isMobile && sidebarOpen && (
            <div className="fixed inset-0 bg-black bg-opacity-25 z-0 backdrop-blur-sm"
        ...
        >
            {/* Top navbar */}
            <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between p-6 sticky top-0 z-30">
